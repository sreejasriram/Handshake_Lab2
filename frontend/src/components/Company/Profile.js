    ...
    fetchCompanydetails(){
        ...
        axios.get(environment.baseUrl+'/company/profile/' + sessionStorage.getItem('id'))
            .then((response) => {
                    ...
                    // if (response.data.rows[0].image) {
                    //     var imgstring = this.arrayBufferToBase64(response.data.rows[0].image.data);
                    //      response.data.rows[0].image = base64Flag + imgstring
                    // }
                this.setState({
            ...
            <Card style={{borderTopRightRadius:'0px',borderTopLeftRadius:'0px'}}>
                    ...
                    <Card>
                        <CardContent>
                            ...
                            <div style={{color: "#1569E0"}}><span class="glyphicon glyphicon-earphone" style={{color: "Black" }}></span>  {this.state.profile.contact}</div>
                        </CardContent>
                    </Card>
                 </div>
                 </div>
